...
public class Circle extends ClosedShape {
    ...
    /**
     * Creates a circle.
	 * @param insertionTime The time the circle enters the window
	 ...
	 * @param flash True if the circle has a second colour, false if does not.
	 * @param sColour The secondary colour to possibly switch to.
	 */
    public Circle (int insertionTime, int x, int y, int vx, int vy, int diameter, Color colour, boolean isFilled,boolean flash, Color sColour) {
