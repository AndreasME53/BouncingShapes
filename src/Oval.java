...
public class Oval extends ClosedShape {
	...
	/**
	 * Creates an oval.
	 *  @param insertionTime The time the oval enters the window
	 ...
	 * @param flash True if the oval has a second colour, false if does not.
	 * @param sColour The secondary colour to possibly switch to.
	 */
	public Oval (int insertionTime, int x, int y, int vx, int vy, int width, int height, Color colour, boolean isFilled,boolean flash, Color sColour) {
